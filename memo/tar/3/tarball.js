...
class TarWriter {
    ...
    _writeFileSize(size, header_offset) {this._writeString(size.toString(8).padStart(11,'0'), header_offset+124, 12)}// offset: 124
    /*
    _writeFileSize(size, header_offset) {// offset: 124
