...
class TarReader {
    ...
    *_getFiles() {
    ...
    /*
    _readFileMode(header_offset) {return this._readString(header_offset+100, 8);}// offset: 100 mode.padStart(7,'0'), 
    _readFileUid(header_offset) {return this._readString(header_offset+108, 8);}//offset:108 this._readString(uid.padStart(7,'0'), 
    _readFileGid(header_offset) {return this._readString(header_offset+116, 8);}// offset: 116 gid.padStart(7,'0'), 
    _readFileMtime(header_offset) {return this._readString(header_offset+136, 12);}// offset: 136 mtime.padStart(11,'0'), 
    _readFileUser(header_offset) {return this._readString(header_offset+265, 32);}// offset: 265 user, 
    _readFileGroup(header_offset) {return this._readString(header_offset+297, 32);}// offset: 297 group, 
    */
